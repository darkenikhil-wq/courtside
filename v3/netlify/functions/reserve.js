...
exports.handler = async (event) => {
  ...
  if (QA_MODE) {
    return jsonResponse(200, {
      ...
      message: 'QA mode accepted this booking request. No WebTrac slot or cart was changed.',
      dryRun: true,
      rules: publicRules(),
...
function bookingSummary(body) {
  return {
    ...
    selectionOnly: body.selectionOnly !== false,
    reserveMode: body.reserveMode || 'select_only',
  };
}
